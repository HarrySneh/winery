...
<head>
	<title><?php if ( is_category() ) {
		echo __('Category Archive for &quot;', 'theme1633'); single_cat_title(); echo __('&quot; | ', 'theme1633'); bloginfo( 'name' );
	} elseif ( is_tag() ) {
		echo __('Tag Archive for &quot;', 'theme1633'); single_tag_title(); echo __('&quot; | ', 'theme1633'); bloginfo( 'name' );
	} elseif ( is_archive() ) {
		wp_title(''); echo __(' Archive | ', 'theme1633'); bloginfo( 'name' );
	} elseif ( is_search() ) {
		echo __('Search for &quot;', 'theme1633').wp_specialchars($s).__('&quot; | ', 'theme1633'); bloginfo( 'name' );
	} elseif ( is_home() || is_front_page()) {
		bloginfo( 'name' ); echo ' | '; bloginfo( 'description' );
	}  elseif ( is_404() ) {
		echo __('Error 404 Not Found | ', 'theme1633'); bloginfo( 'name' );
	} elseif ( is_single() ) {
		wp_title('');
	} else {
      ...
      <div class="container_12 clearfix">
         <div class="grid_12">
            ...
            <div id="authorization">
               ...
               <?php } else { ?>
                  <?php _e('Have an account?', 'theme1392');?> <?php wp_loginout(); ?> <?php _e('or', 'theme1392');?> <a href="<?php bloginfo('url'); ?>/wp-login.php?action=register"><?php _e('Sign up', 'theme1392');?></a>
               <?php } ?>
            </div>
